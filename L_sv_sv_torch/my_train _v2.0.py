...
# @Author : wuhuaisj
# @time   : 2021/4/7 9:01
# v2.0 代码较为完善，但是存在调参问题，需要继续改进
# resnet triplet loss 多个正样本
import os
import time
import torch
...
train_dataset = ProcessData(image_path, train=True,positive_size=positive_size, transform=data_transform['train'])
...
# 模型太大会出现显卡带不动的情况(axb)
net_use = 'resnet34'
print("using {}  for training".format(net_use))
model_urls = {
