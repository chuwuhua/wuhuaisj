...
path = "D:\\项目工作\\不完备数据\\数据融合实验\\原始数据\\长沙市芙蓉区街景地图\\"
headers = {
...
def getImage(utm_x, utm_y, city):
    ...
    url = 'https://sv.map.qq.com/xf?lat=' \
          ...
          + '&r=30&key=ba56844b2a30311fe2149b485ca2a031&output=jsonp&pf=jsapi&ref=jsapi&cb=qq.maps._svcb3.cbk3rdpp035'
    try:
